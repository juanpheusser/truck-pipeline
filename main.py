...
from pipeline.common.mongo_connector import MongoConnector
import pandas as pd
import logging
...
def main():
    ...
    mongoConnector = MongoConnector(
        ...
        db=mongo_config['db'],
        reportCollection=mongo_config['reportCollection'],
        truckCollection=mongo_config['truckCollection']
    )
    ...
    mongoConnector.pipelineFlow(f_data)
